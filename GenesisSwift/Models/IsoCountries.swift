...
extension IsoCountryInfo: Equatable {
    public static func == (lhs: IsoCountryInfo, rhs: IsoCountryInfo) -> Bool {
...
public final class IsoCountries {
    ...
    public class var allCountries: [IsoCountryInfo] {
        [IsoCountryInfo(name: "Afghanistan", numeric: "004", alpha2: "AF", alpha3: "AFG", calling: "+93", currency: "AFN", continent: "AS"),
         ...
         IsoCountryInfo(name: "North Macedonia", numeric: "807", alpha2: "MK", alpha3: "MKD", calling: "+389", currency: "MKD", continent: "EU"),
